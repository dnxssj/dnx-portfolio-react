...
{/* FADE IZQUIERDA */}
<div className="hidden sm:block pointer-events-none absolute left-0 top-0 h-full w-20 
  bg-gradient-to-r from-fondo via-fondo/30 to-transparent z-10" />

{/* FADE DERECHA */}
<div className="hidden sm:block pointer-events-none absolute right-0 top-0 h-full w-20 
  bg-gradient-to-l from-fondo via-fondo/30 to-transparent z-10" />
          ...
          >
            {loopData.map((t, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="bg-black/40 backdrop-blur-sm border rounded-xl p-4 sm:p-6 transition-all duration-300 hover:bg-turquesa/10 hover:shadow-[0_0_15px_rgba(46,233,164,0.4)]"
                    style={{
        ...
        <button
          ...
          className="absolute left-2 sm:left-6 top-1/2 -translate-y-1/2 z-30
            ...
            rounded-full
            hover:bg-turquesa/10
            hover:shadow-[0_0_25px_rgba(46,233,164,0.6)]
