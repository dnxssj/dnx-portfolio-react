      ...
      <div className="flex justify-center gap-8">
        ...
        <div className="relative group">
          <motion.button
            ...
            className="text-turquesa w-8 h-8 transition"
          ...
          {/* Tooltip visual */}
          <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black text-xs text-crema px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20">
            Click to copy
          </span>
        </div>
        ...
        {copied && (
          <p className="text-sm text-crema text-opacity-70 mt-4 animate-pulse">
            Copied Discord ID: <span className="text-turquesa font-mono">@dnxssj</span>
          </p>
        )}
